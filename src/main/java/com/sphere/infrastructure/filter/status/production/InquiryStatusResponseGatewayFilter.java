...
@Slf4j
@Component
public class InquiryStatusResponseGatewayFilter extends AbstractResponseGatewayFilter
        implements GatewayFilter, Ordered {

    @Resource
    InquiryStatusResponseService inquiryStatusResponseService;
    ...
    public BiFunction<ServerWebExchange, String, Mono<String>> modifyBody() {
        return (serverWebExchange, raw) -> {
            ...
            String convert = inquiryStatusResponseService.handlerResponse(serverWebExchange, raw);
