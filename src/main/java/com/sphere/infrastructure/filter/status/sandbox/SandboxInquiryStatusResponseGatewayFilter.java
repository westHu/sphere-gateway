...
@Slf4j
@Component
public class SandboxInquiryStatusResponseGatewayFilter extends AbstractResponseGatewayFilter
        implements GatewayFilter, Ordered {

    @Resource
    SandboxInquiryStatusResponseService sandboxInquiryStatusResponseService;
