package com.sphere.infrastructure.filter.transaction.sandbox;
...
@Slf4j
@Component
public class SandboxTransactionPayInResponseGatewayFilter extends AbstractResponseGatewayFilter
        implements GatewayFilter, Ordered {

    @Resource
    SandboxTransactionPayInResponseService sandboxTransactionPayInResponseService;
    ...
    protected BiFunction<ServerWebExchange, String, Mono<String>> modifyBody() {
        return (serverWebExchange, raw) -> {
            ...
            String convert = sandboxTransactionPayInResponseService.handlerResponse(serverWebExchange, raw);
