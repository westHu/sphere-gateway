...
@Slf4j
@Component
public class SandboxDisbursementCashOutResponseGatewayFilter extends AbstractResponseGatewayFilter
        implements GatewayFilter, Ordered {

    @Resource
    SandboxDisbursementCashOutResponseService sandboxDisbursementCashOutResponseService;
    ...
    protected BiFunction<ServerWebExchange, String, Mono<String>> modifyBody() {
        return (serverWebExchange, raw) -> {
            ...
            String convert = sandboxDisbursementCashOutResponseService.handlerResponse(serverWebExchange, raw);
