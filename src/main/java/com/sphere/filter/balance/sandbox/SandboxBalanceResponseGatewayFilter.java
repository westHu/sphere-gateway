package com.sphere.filter.balance.sandbox;
...
@Slf4j
@Component
public class SandboxBalanceResponseGatewayFilter extends AbstractResponseGatewayFilter
        implements GatewayFilter, Ordered {

    @Resource
    SandboxBalanceResponseService sandboxBalanceResponseService;
